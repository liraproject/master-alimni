                ...
                [
                    ...
                    'sub_menu' => [
                        [
                            ...
                            'route' => 'admin.forms.components',
                        ],
                        [
                            'title' => 'Form Layouts',
                            'route' => 'admin.forms.layouts',
                        ],
                    ],
                ],
                [
                    ...
                    'sub_menu' => [
                        ...
                        [
                            'title' => 'Table',
                            'route' => 'admin.components.table',
                        ],
                        [
                            'title' => 'Chart (Apexchart)',
                            'route' => 'admin.components.chart',
                        ],
                    ],
                ],
                [
