    ...
    <div class="fixed right-0 top-0 z-[151] h-full w-full sm:w-80">
        <div x-data="{ activeTab: 'tabHome' }"
            ...
            <div x-show="activeTab === 'tabHome'" x-transition:enter="transition-all duration-500 easy-in-out"
                    ...
                    <div class="px-3 mt-3 swiper" x-init="$nextTick(() => new Swiper($el, { slidesPerView: 'auto', spaceBetween: 16 }))">
                        <div class="swiper-wrapper">
                            ...
                            <div
                                ...
                                <div class="absolute bottom-0 right-0 -m-3 mask is-diamond size-16 bg-white/20">
                                </div>
                            </div>
                            <div
                                ...
                                <div class="absolute top-0 right-0 -m-3 mask is-hexagon-2 size-16 bg-white/20"></div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="px-3 mt-4">
                    ...
                    <div class="flex mt-3 space-x-3">
                        <a wire:navigate href="#" class="w-12 text-center">
                            <div class="avatar size-10">
                                <div class="text-white is-initial mask is-squircle bg-success">
                        ...
                        <a wire:navigate href="#" class="w-12 text-center">
                            <div class="avatar size-10">
                                <div class="text-white is-initial mask is-squircle bg-warning">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="size-5" fill="none"
                                        viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                        <path stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <a wire:navigate href="#" class="w-12 text-center">
                            <div class="avatar size-10">
                                <div class="text-white is-initial mask is-squircle bg-info">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="size-5" fill="none"
                                        viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                        <path stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <a wire:navigate href="#" class="w-12 text-center">
                            <div class="avatar size-10">
                                <div class="text-white is-initial mask is-squircle bg-error">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="size-5" fill="none"
                                        viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                        ...
                        <a wire:navigate href="#" class="w-12 text-center">
                            <div class="avatar size-10">
                                <div class="text-white is-initial mask is-squircle bg-secondary">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="size-5" fill="none"
                                        viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                        <path stroke-linecap="round" stroke-linejoin="round"
            ...
            <div x-show="activeTab === 'tabProjects'" x-transition:enter="transition-all duration-500 easy-in-out"
                ...
                <div class="p-3 mt-4 border rounded-lg border-slate-150 dark:border-navy-600">
                    ...
                    <div class="flex items-center justify-between mt-3 space-x-2">
                        ...
                        <button
                            class="p-0 font-medium rounded-full btn size-7 bg-slate-150 text-slate-800 hover:bg-slate-200 focus:bg-slate-200 active:bg-slate-200/80 dark:bg-navy-500 dark:text-navy-50 dark:hover:bg-navy-450 dark:focus:bg-navy-450 dark:active:bg-navy-450/90">
            ...
            <div x-show="activeTab === 'tabActivity'" x-transition:enter="transition-all duration-500 easy-in-out"
                ...
                x-transition:enter-end="opacity-100 [transform:translate3d(0,0,0)]"
                class="pt-1 overflow-y-auto is-scrollbar-hidden overscroll-contain">
                <div class="flex flex-col items-center px-8 py-3 mx-3 rounded-lg bg-slate-100 dark:bg-navy-600">
                    ...
                    <div class="h-2 mt-3 progress bg-secondary/15 dark:bg-secondary-light/25">
                        <div
                            class="relative w-8/12 overflow-hidden rounded-full is-active bg-secondary dark:bg-secondary-light">
                        </div>
                    </div>
                        ...
                        <div class="flex-1 pl-4 timeline-item-content">
                            ...
                            <div>
                                ...
                                <div class="flex justify-between mt-2">
                                    ...
                                    <button
                                        class="p-0 font-medium rounded-full btn size-7 bg-slate-150 text-slate-800 hover:bg-slate-200 focus:bg-slate-200 active:bg-slate-200/80 dark:bg-navy-500 dark:text-navy-50 dark:hover:bg-navy-450 dark:focus:bg-navy-450 dark:active:bg-navy-450/90">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="rotate-45 size-5"
