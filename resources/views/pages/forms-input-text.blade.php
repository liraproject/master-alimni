<x-app-layout title="Input Text" is-sidebar-open="true" is-header-blur="true">
    <main class="main-content w-full px-[var(--margin-x)] pb-8">
        ...
        <div class="grid grid-cols-1 gap-4 sm:gap-5 lg:gap-6">
            <!-- Basic Input Text -->
            <div class="px-4 pb-4 card sm:px-5">
                <div class="flex items-center justify-between h-8 my-3">
                    ...
                    <label class="flex items-center space-x-2">
                        ...
                        <input @change="helpers.toggleCode"
                            class="w-10 h-5 rounded-full form-switch bg-slate-300 before:rounded-full before:bg-slate-50 checked:bg-primary checked:before:bg-white dark:bg-navy-900 dark:before:bg-navy-300 dark:checked:bg-accent dark:checked:before:bg-white"
                            type="checkbox" />
                    </label>
                </div>
                ...
                <div class="max-w-xl">
                    ...
                    <div class="mt-5">
                        <label class="block">
                            <input
                                class="w-full px-3 py-2 bg-transparent border rounded-lg form-input border-slate-300 placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent"
                                placeholder="Username" type="text" />
                        </label>
                    </div>
                </div>

                <div class="hidden pt-4 code-wrapper">
                    <pre class="overflow-auto rounded-lg is-scrollbar-hidden max-h-96" x-init="hljs.highlightElement($el)">
            ...
            <div class="px-4 pb-4 card sm:px-5">
                ...
                <div class="max-w-xl">
                    ...
                    <div class="mt-5">
                        <label class="block">
                            <input
                                class="w-full px-3 py-2 rounded-lg form-input bg-slate-150 ring-primary/50 placeholder:text-slate-400 hover:bg-slate-200 focus:ring dark:bg-navy-900/90 dark:ring-accent/50 dark:placeholder:text-navy-300 dark:hover:bg-navy-900 dark:focus:bg-navy-900"
                                placeholder="Username" type="text" />
                        </label>
                    </div>
                </div>
            ...
            <div class="px-4 pb-4 card sm:px-5">
                ...
                <div class="max-w-xl">
                    ...
                    <div class="mt-5 space-y-4">
                        ...
                        <label class="block">
                            <input
                                class="w-full h-12 px-4 py-2 text-base bg-transparent border rounded-full form-input border-slate-300 placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent"
                                placeholder="Username" type="text" />
                        </label>
                    </div>
                </div>
                ...
                <div class="max-w-xl">
                    ...
                    <div class="mt-5 space-y-4">
                        <div>
                            <label class="block">
                                <input
                                    class="w-full px-3 py-2 bg-transparent border rounded-lg form-input border-success placeholder:text-slate-400/70"
                        ...
                        <div>
                            <label class="block">
                                <input
                                    class="w-full px-3 py-2 bg-transparent border rounded-lg form-input border-error placeholder:text-slate-400/70"
                                    placeholder="Username" type="text" value="Some Value" />
                            </label>
